...
@section('content')
    <div class="page-body">
        <div class="col-sm-12 p-1">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="updateForm" action="{{ route('classes.update', $class->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ old('name', $class->name) }}" placeholder="Class Name" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="start_at" name="start_at"
                                        value="{{ old('start_at', $class->start_at) }}" placeholder="Class Start At"
                                        required>
                                    @error('start_at')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="quota" name="quota"
                                        value="{{ old('quota', $class->quota) }}" placeholder="Class Quota" required>
                                    @error('quota')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="duration" name="duration"
                                        value="{{ old('duration', $class->duration) }}" placeholder="Class Duration"
                                        required>
                                    @error('duration')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="price" name="price"
                                        value="{{ old('price', $class->price) }}" placeholder="Class Price" required>
                                    @error('price')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="Class Description" rows="5">{{ old('description', $class->description) }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <select class="form-control" id="tutor_id" name="tutor_id" required>
                                        ...
                                        @foreach ($tutors as $tutor)
                                            <option value="{{ $tutor->id }}"
                                                {{ old('tutor_id', $class->tutor_id) == $tutor->id ? 'selected' : '' }}>
                                                {{ $tutor->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <img id="imagePreview" src="{{ asset('storage/' . $class->image_url) }}"

    ...
    <div class="page-body">
        <div class="col-sm-12 p-1">
            <div class="d-flex justify-content-between align-items-center m-4">
                <div>
                    <h5>Buat Studio Baru</h5>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <form id="createForm" action="{{ route('studios.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price"
                                value="{{ old('price') }}" placeholder="Price" min="10000" required>
                            @if ($errors->has('price'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="owner" name="owner"
                                value="{{ old('owner') }}" placeholder="Owner" required>
                            @if ($errors->has('owner'))
    ...
    <script>
        ...
        function submitCreateForm() {
            Swal.fire({
                ...
                text: "Data studio baru akan ditambahkan!",
                icon: 'warning',
